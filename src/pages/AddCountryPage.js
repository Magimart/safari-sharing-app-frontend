...
const AddCountryPage = ({ countries }) => {
      ...
      <div className={classes.containerWrapper}>
        <Grid container spacing={3}>
          <Grid item xs={12}>
            <Paper className={classes.divWrapper}>
              <div className="simple-trans-main" >
                {transitions.map(({ item, props, key }) => {
                  ...
                  return <Page nextPage={nextPage} key={key} style={props} />
                })}
              </div>
            ...
            <Paper className={classes.countryButtomWrap}>
              {/* {countries && countries.map((country) => console.log(country.name))} */}

              <AddCountryForm nextPage={nextPage} countries={countries} />
